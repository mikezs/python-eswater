...
def test_account_summary_and_details_parse() -> None:
    ...
    assert account.account_id == "1000000000"
    assert account.premise_id == "2000000000"
    ...
    assert meter.serial == "TESTMETER01"
    assert meter.account_id == "1000000000"
    assert meter.premise_id == "2000000000"
    assert meter.smart_point == "00000000"
